...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            organization::storage_commands::api_delete_session_audio,
            organization::storage_commands::api_compress_session_audio,
            organization::storage_commands::api_delete_sessions,
            start_recording,
            stop_recording,
            is_recording,
